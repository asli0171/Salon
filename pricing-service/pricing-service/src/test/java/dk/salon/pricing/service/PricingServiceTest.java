...
class PricingServiceTest {
    ...
    void should_add_premium_surcharge() {
        ...
        assertEquals(420.0, result); // 350 + 20% = 420
    }
    ...
    void should_add_colour_surcharge() {
        ...
        assertEquals(850.0, result); // 750 + 50 farvetillæg + 50 lang behandling
    }
    ...
    void should_add_long_duration_surcharge() {
        ...
        assertEquals(630.0, result); // 550 + 30 behandlingstillæg + 50 lang behandling
    }
