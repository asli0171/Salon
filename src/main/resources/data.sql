...
('admin', '$2a$10$pJocfzZTpxpUedDf/mpnkO8/OpWCcsNSFGQpIXtF5p19yJSe6C4Pq');
-- password: admin123

INSERT IGNORE INTO hairdresser (name, bio, active) VALUES
    ('Helin', 'Indehaver, frisør og kosmetolog med speciale i farveteknikker og avancerede ansigtsbehandlinger.', true);

INSERT IGNORE INTO service (name, description, duration_minutes, base_price) VALUES
...
INSERT IGNORE INTO slot (hairdresser_id, service_id, start_time, end_time, is_available) VALUES
